 ...
 * 3. java.util.LocalDate, java.util.LocalTime, java.util.LocalDateTime 클래스 ==>8버전에서 추가
 * 
 * 
 * */
...
public class CalendarEx1 {
	...
	public static void main(String[] args) {
		...
		//추상 클래스, interface = new를 못하기 때문에 자식클래스
		...
		System.out.println("시간(0~시간) : "+today.get(Calendar.HOUR));
