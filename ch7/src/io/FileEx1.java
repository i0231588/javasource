...
public class FileEx1 {
	...
	public static void main(String[] args) throws IOException {
		...
		//getAbsolutePath(): 파일의 절대 경로 , getCannicalPath(): 파일의 정규 경로
		...
		System.out.println("File.pathSepartor : "+File.pathSeparatorChar);
		//File.separator: 운영체제에서 사용하는 이름 구분자(윈도우: \, 유닉스: /)
		System.out.println("File.pathSepartor : "+File.separator);
		System.out.println("File.pathSepartor : "+File.separatorChar);
